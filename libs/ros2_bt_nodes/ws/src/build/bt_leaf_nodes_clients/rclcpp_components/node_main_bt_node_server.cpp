...
#define NODE_MAIN_LOGGER_NAME "bt_node_server"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libBT_node_client.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<bt_leaf_nodes_servers::BTNodeServer>";
